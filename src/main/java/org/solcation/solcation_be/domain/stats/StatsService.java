...
public class StatsService {
    ...
    public InsightDTO generateTravelInsight(Long tpPk) {
        ...
        String prompt = """
                ...
                - 포함: 전체 소비 패턴 분석, 절약 할 방법 표시, 그룹 평균과의 비교 한줄로 여러줄로 출력 금지
                - 각 분석마다 앞에 패턴:, 절약:, 비교: 라고 태그 붙이고 그 뒤에 한줄로 간략하게 소비한 내용에 대해서만 반드시 한줄로 제공해줘
                - 패턴: 1개 절약: 1개 비교: 1개 씩 주기 이 외는 출력 하지 않기
                - 사족 제거 태그 붙이고 분석만 출력하기
